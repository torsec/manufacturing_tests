...
typedef struct mbedtls_x509write_cert
{
	...
	// Changes
	mbedtls_asn1_named_data issuer_arr[8];
	mbedtls_asn1_named_data subject_arr[8];
	mbedtls_asn1_named_data extens_arr[4];
	int ne_issue_arr;
	int ne_subje_arr;
	int ne_ext_arr;
...
typedef struct mbedtls_x509_crt
{
	...
	mbedtls_asn1_named_data_noarr issuer_arr[8];
	mbedtls_asn1_named_data_noarr subject_arr[8];
	int ne_issue_arr;
	int ne_subje_arr;
